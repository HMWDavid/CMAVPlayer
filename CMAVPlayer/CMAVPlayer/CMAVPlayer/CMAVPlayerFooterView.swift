...
class CMAVPlayerFooterView: UIView {
    ...
    private func setSubViewConstraint(){
        ...
        self.fullScreenBtn = {
            ...
            fullBtn.setImage(UIImage.init(named:"Player_fullscreen"), for: .normal)
            fullBtn.setImage(UIImage.init(named:"Player_shrinkscreen"), for: .selected)
        ...
        self.playOrPauseBtn = {
            ...
            tempPlayBtn.isSelected = true
            tempPlayBtn.setImage(UIImage.init(named:"Player_pause"), for: .normal)
            tempPlayBtn.setImage(UIImage.init(named:"Player_play"), for: .selected)
