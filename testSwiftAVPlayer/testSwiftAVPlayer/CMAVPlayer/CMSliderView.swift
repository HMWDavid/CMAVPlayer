...
class CMSliderView: UIView {
   ...
   /// 背景
    ...
    override func layoutSubviews() {
        ...
        self.bufferProgressView.frame.size.width = self.bgProgressView.frame.size.width * CGFloat(self.bufferValue)
        self.sliderProgressView.frame.size.width = self.bgProgressView.frame.size.width * CGFloat(self.value)
    ...
    public var bufferValue:Float = 0.0{
        willSet{
            ...
            self.bufferProgressView.frame.size.width = self.bgProgressView.frame.width * CGFloat(multipliedValue)
        }
    }
